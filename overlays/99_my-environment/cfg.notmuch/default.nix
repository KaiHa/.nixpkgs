{stdenv, aescrypt, bash, coreutils, findutils, glibcLocales, notmuch, offlineimap, tzdata, writeText}:
...
let
  fmService = writeText "fetch-mail.service" ''
    ...
    Environment="PATH=${findutils}/bin:${bash}/bin:${notmuch}/bin:${coreutils}/bin:${offlineimap}/bin"
